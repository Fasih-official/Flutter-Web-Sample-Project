...
import 'package:assessment_app/screens/dashboard/image_observation.dart';
import 'package:assessment_app/screens/dashboard/side_bar.dart';
import 'package:assessment_app/screens/dashboard/text_observation.dart';
import 'package:assessment_app/screens/dialogues/add_observation_pop_up.dart';
import 'package:assessment_app/utils/decorations.dart';
import 'package:assessment_app/utils/dialogs.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    InkResponse(
                                      onTap: () {
                                        onTapAddObservation(context, index);
                                      },
                                      child: SizedBox(
                                        width: (actualCardWidth / 14) * 1.1,
                                        child: Text(
                                ...
                                verticalSpace(),
                                (state is UIStateAddObservation)
                                    ? Visibility(
  ...
  void onTapAddObservation(BuildContext context, int index) {
    showFullWidthDialog(context, AddObservationPopup(
