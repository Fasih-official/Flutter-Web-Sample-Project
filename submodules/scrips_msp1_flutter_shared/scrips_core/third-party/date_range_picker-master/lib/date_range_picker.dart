...
enum DatePickerRange {
  /// Show a date picker UI for single date selection.
  single,

  /// Show a date picker UI for range selection.
  multi,
}

const double _kDatePickerHeaderPortraitHeight = 72.0;
const double _kDatePickerHeaderLandscapeWidth = 72.0;

const Duration _kMonthScrollDuration = Duration(milliseconds: 200);
const double _kDayPickerRowHeight = 34.0;
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle =
        headerTextTheme.displayMedium.copyWith(color: dayColor, height: 1.4);
    ...
    switch (themeData.brightness) {
      case Brightness.light:
        backgroundColor = enabledBtnBGColor;
        break;
      case Brightness.dark:
        backgroundColor = enabledBtnBGColor;
        break;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        TextStyle itemStyle = normalLabelTextStyle(13, regularTextColor);
        ...
        if (isSelectedFirstDay &&
          ...
          decoration = new BoxDecoration(
              color: enabledBtnBGColor, shape: BoxShape.circle);
        ...
        children: <Widget>[
          new Container(
            ...
            child: new Center(
              child: new ExcludeSemantics(
                child: new Text(
                  localizations.formatMonthYear(displayedMonth).toUpperCase(),
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void didChangeDependencies() {
    ...
    if (!_announcedInitialDate) {
      ...
      if (_selectedLastDate != null && selectedRange == DatePickerRange.multi) {
        SemanticsService.announce(
...
Future<List<DateTime>> showDatePicker({
  ...
  @required DatePickerRange range,
